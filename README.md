Repozytorium zawiera Projekt 3 - biblioteka dla Python w CPP znajdująca się w src/main.cpp, plik python odtwarzający tą bibliotekę w tests/test.py oraz plik CMake oraz pliki pomocnicze. 
